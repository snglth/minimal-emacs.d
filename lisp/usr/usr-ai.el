;;; usr-ai.el --- AI tools configuration -*- lexical-binding: t; -*-
...
(use-package gptel
 ...
 :defer t
 :commands (gptel gptel-send gptel-request gptel-mode)
 :config
...
;; Extend gptel-menu with buffer-tail context command.
;; Uses gptel-context-add-buffer-tail directly (defined above) to avoid
;; transient suffix symbol resolution issues with deferred gptel loading.
(with-eval-after-load 'gptel-transient
 (transient-append-suffix 'gptel-menu "-b"
  '("-t" "Add buffer tail to context" gptel-context-add-buffer-tail
    :transient t)))
